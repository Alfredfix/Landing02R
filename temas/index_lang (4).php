...
<main class="louvre-theme">
    <!-- HERO SECTION -->
    <section class="louvre-hero" style="background: linear-gradient(rgba(0, 0, 0, 0.55), rgba(0, 0, 0, 0.65)), url('<?= $hero_image ?? "/img/hero-louvre.jpg" ?>') center/cover no-repeat;">
                ...
                <div class="tour-card" data-tour-id="<?= $key_tour ?>">
                    ...
                    <div class="tour-card-content">
                        ...
                        <div class="tour-buttons-container">
                            ...
                            <button class="tour-buy-btn" onclick="openModal('<?= addslashes($title) ?>')">
        ...
        <div class="louvre-info-carousel">
            <div class="louvre-info-slide active">
                ...
                <div class="louvre-info-image">
                    <img src="https://images.unsplash.com/photo-1565060169194-19fabf63012c?w=800&q=80" alt="<?= $connection->tra("Historia del Louvre") ?>">
                </div>
            </div>
            ...
            <div class="louvre-info-slide">
                ...
                <div class="louvre-info-image">
                    <img src="https://images.unsplash.com/photo-1568385247005-0d371d214a5e?w=800&q=80" alt="<?= $connection->tra("La Mona Lisa") ?>">
                </div>
            </div>
